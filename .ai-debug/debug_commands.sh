...
pwd
test -f deployment/docker-compose.yml && echo compose_file_ok
...
COMPOSE_BAKE=false docker compose -f deployment/docker-compose.yml version
COMPOSE_BAKE=false docker compose -f deployment/docker-compose.yml config -q && echo compose_config_ok
