...
ConnectionStrings__Postgres=Host=${private_ip};Port=5432;Database=argus_v2;Username=argus;Password=argus
ConnectionStrings__FileStore=Host=${private_ip};Port=5432;Database=argus_v2_files;Username=argus;Password=argus
