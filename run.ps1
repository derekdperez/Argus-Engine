...
$LocalEnv = @(
'ARGUS_ENGINE_VERSION=local',
'ARGUS_DIAGNOSTICS_API_KEY=local-dev-diagnostics-key-change-me',
'ARGUS_LOCAL_BASE_URL=http://localhost:8081',
'ARGUS_WEB_BASE_URL=http://localhost:8082',
'argus_DEPLOY_MODE=hot',
'argus_SKIP_INSTALL=0',
...
$DevEnv = @(
'ARGUS_ENGINE_VERSION=dev-local',
'ARGUS_DIAGNOSTICS_API_KEY=replace-me-dev',
'ARGUS_LOCAL_BASE_URL=http://localhost:8081',
'ARGUS_WEB_BASE_URL=http://localhost:8082',
'argus_DEPLOY_MODE=hot',
...
$StagingEnv = @(
'ARGUS_ENGINE_VERSION=staging',
'ARGUS_DIAGNOSTICS_API_KEY=replace-me-staging',
'ARGUS_LOCAL_BASE_URL=http://localhost:8081',
'ARGUS_WEB_BASE_URL=http://localhost:8082',
...
$ProductionEnv = @(
'ARGUS_ENGINE_VERSION=production',
'ARGUS_DIAGNOSTICS_API_KEY=replace-me-production',
'ARGUS_LOCAL_BASE_URL=http://localhost:8081',
'ARGUS_WEB_BASE_URL=http://localhost:8082',
'argus_DEPLOY_MODE=image',
'argus_SKIP_INSTALL=1',
...
Write-LfFile "deploy/deploy-ui.py" $DeployUi
Write-LfFile "deploy/DEPLOYOPS_README.md" $Readme
Write-LfFile "deploy/config/argus.local.env.example" $LocalEnv
Write-LfFile "deploy/config/argus.dev.env.example" $DevEnv
Write-LfFile "deploy/config/argus.staging.env.example" $StagingEnv
Write-LfFile "deploy/config/argus.production.env.example" $ProductionEnv
...
dir .\argus-engine-deployops-patch.zip