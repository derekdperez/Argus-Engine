...
namespace ArgusEngine.Application.Sagas;
...
public interface IStartScanEvent { string Domain { get; } }
public interface IEnumCompletedEvent { string Domain { get; } }
public interface IProfilingCompletedEvent { string Domain { get; } }
public interface IScanFaultedEvent { string Domain { get; } }
public record TriggerEnumJob { public string Domain { get; init; } = ""; }
public record TriggerProfilingJob { public string Domain { get; init; } = ""; }
public record TriggerFuzzingJob { public string Domain { get; init; } = ""; }
