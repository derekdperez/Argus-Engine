...
public partial class ArgusDataGrid<TGridItem> : IAsyncDisposable
{
    ...
    private async Task ExportCsvAsync()
    {
        ...
        await Js.InvokeVoidAsync("argusUi.downloadTextFile", fileName, csv, "text/csv;charset=utf-8");
    }
    ...
    private async Task LoadPreferencesAsync()
    {
        ...
        try
        {
            var json = await Js.InvokeAsync<string?>("argusUi.getLocalStorage", StorageKey);
    ...
    private async Task SavePreferencesAsync()
    {
        ...
        try
        {
            ...
            await Js.InvokeVoidAsync("argusUi.setLocalStorage", StorageKey, json);
        }
        catch (InvalidOperationException)
        {
        }
