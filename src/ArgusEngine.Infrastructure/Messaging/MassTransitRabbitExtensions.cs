        ...
        Action<IBusRegistrationConfigurator> configureConsumers)
    {
        ...
        services.AddOptions<RabbitMqOptions>()
            .Configure(options =>
            {
                ...
                options.WaitUntilStarted = GetBool(rabbitSection, nameof(RabbitMqOptions.WaitUntilStarted), options.WaitUntilStarted);
            ...
            .Validate(o => o.StartTimeoutSeconds is >= 1 and <= 300, "RabbitMq:StartTimeoutSeconds must be between 1 and 300.")
