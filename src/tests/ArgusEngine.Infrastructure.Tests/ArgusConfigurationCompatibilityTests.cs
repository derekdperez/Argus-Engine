...
public sealed class ArgusConfigurationCompatibilityTests
{
    ...
    public void GetArgusValue_prefers_current_argus_key_over_legacy_nightmare_key()
    {
        var configuration = Build(
            new KeyValuePair<string, string?>("Argus:WorkerScaling:MaxDesiredCount", "7"),
            new KeyValuePair<string, string?>("Nightmare:WorkerScaling:MaxDesiredCount", "3"));
    ...
    {
        var configuration = Build(new KeyValuePair<string, string?>("Nightmare:WorkerScaling:MaxDesiredCount", "3"));
    ...
    {
        var configuration = Build(new KeyValuePair<string, string?>("ARGUS_QUEUE_HTTP_DEPTH", "42"));
    ...
    {
        var configuration = Build(new KeyValuePair<string, string?>("NIGHTMARE_QUEUE_HTTP_DEPTH", "41"));
    ...
    {
        var configuration = Build(
            new KeyValuePair<string, string?>("Argus:Feature:Enabled", "true"),
            new KeyValuePair<string, string?>("Argus:Feature:MaxItems", "12"));
